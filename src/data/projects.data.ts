...
export const Projects: Project[] = [
    ...
    },
    {
        ...
        description: "Aplicación web basada en la recopilación de productos y su clasificación. Permite recopilar información basica sobre productos tecnologicos en almacenes de cadena haciendo uso de Web  Scrapping, fue desarrollado en HTML, CSS, Vite y Javascript",
        images: [PriceHive],
        urlGithub: "",
    },
    {
